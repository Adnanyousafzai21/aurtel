...
const MainpageText = () => {
  return (
    <div className="m-auto py-5 md:w-[70%] px-5 lg:w-[70%]">
      <div className="w-full">
        <h1 className='py-2 text-[20px] md:text-[25px] font-[700] text-primary'>Introduction</h1>
        <p className='md:text-[15px] text-[14px] leading-6 '>We are a specialized contract advisory firm redefining consultancy for the
      ...
      <div className="flex-col mt-7 flex md:text-[15px] text-[14px] font-bold justify-start gap-2 lg:w-[60%] sm:w-[70%] w-[90%]">
